...
import type { AppProjectionPlugin } from "../runtime";
  ...
  return [
    {
      ...
      payload: {
        ...
        createdAt: input.now,
      } as PermissionCreateEnvelopePayload,
    },
    {
      ...
      payload: {
        ...
        updatedAt: input.now,
      } as PermissionGroupMetadataPayload,
      protection: {
        type: "recipients",
